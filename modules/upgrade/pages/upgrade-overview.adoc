...
[role="_abstract"]
Understand what happens during an {prod-short} upgrade so that you can plan the timing, communicate downtime expectations, and verify the result.
...
* link:https://github.com/eclipse/che/blob/{project-context}/CHANGELOG.md[{prod-short} release changelog]
